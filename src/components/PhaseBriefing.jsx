  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 sm:p-6 animate-in fade-in zoom-in duration-300">
      ...
      <div className={`relative max-w-md w-full max-h-[90vh] overflow-y-auto custom-scrollbar p-6 sm:p-8 rounded-[2.5rem] border shadow-2xl transition-all 
        bg-explore-nav border-explore-border text-content-main shadow-primary/10`}>

        {/* HEADER */}
        <div className="flex items-start justify-between mb-6">
          <div className="pr-4">
            <h4 className="text-[10px] font-black uppercase tracking-[0.3em] text-primary mb-1 leading-none">Briefing Phase</h4>
            <h2 className="text-2xl font-black uppercase tracking-tighter leading-tight">
              {data.title}
            </h2>
          </div>
          <div className="w-12 h-12 bg-primary-hover rounded-2xl flex-none flex items-center justify-center text-2xl shadow-lg shadow-primary/20">🚀</div>
        </div>
        ...
        <div className="p-4 rounded-2xl mb-8 border border-primary/20 bg-primary/5">
          <p className="text-[10px] italic text-primary leading-relaxed text-center">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex items-center justify-center py-1">
            <label className="flex items-center cursor-pointer group select-none">
              ...
              />
              <div className="w-4 h-4 flex-none rounded border border-explore-border bg-explore-item peer-checked:bg-primary peer-checked:border-primary transition-all flex items-center justify-center">
