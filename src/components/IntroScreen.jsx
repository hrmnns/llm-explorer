...
const IntroScreen = ({ onStart, theme }) => {
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center p-8 overflow-y-auto custom-scrollbar bg-gradient-to-b from-transparent to-blue-500/5">
      <div className="max-w-5xl w-full">
        {/* HEADER SECTION */}
        <div className="text-center mb-16 animate-in fade-in slide-in-from-top duration-1000">
          <h1 className="text-5xl lg:text-6xl font-black tracking-tighter mb-4 bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent uppercase">
            LLM Explorer
          </h1>
            ...
            >
              ...
              <div className="flex-1 mb-8">
                ...
                <p className="text-sm text-slate-400 leading-relaxed font-medium">
                  {s.explanation || "In diesem Szenario untersuchen wir die Standard-Verarbeitungspfade des Modells ohne spezifische Gewichtung."}
                </p>
              </div>
