    ...
    <div className="flex-1 flex flex-col items-center justify-center lg:justify-start p-8 lg:pt-20 py-12 overflow-y-auto custom-scrollbar bg-gradient-to-b from-transparent to-blue-500/5">
      <div className="max-w-5xl w-full">
        ...
        <div className="text-center mb-16 animate-in fade-in slide-in-from-top duration-1000">
          <h1 className="text-5xl lg:text-6xl font-black tracking-tighter mb-2 bg-gradient-to-r from-primary to-purple-600 bg-clip-text text-transparent uppercase">
            LLM Explorer
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {scenarios.map((s, idx) => (
            <div
              ...
              className="group relative p-8 rounded-[2rem] border border-explore-border bg-explore-card hover:bg-explore-item hover:border-primary/40 transition-all duration-500 cursor-pointer shadow-2xl flex flex-col animate-in fade-in zoom-in duration-700"
            ...
            >
              ...
              <div className="mb-6">
                <h3 className="text-[10px] font-black uppercase tracking-[0.4em] text-primary mb-2">Szenario {s.id}</h3>
                <h2 className="text-3xl font-black text-content-main group-hover:text-primary transition-colors">
                  {s.name}
                </h2>
              </div>
              ...
              <div className="flex items-center justify-between pt-4 border-t border-explore-border">
                <span className="text-[10px] font-bold uppercase tracking-widest text-content-dim group-hover:text-primary transition-colors">
                  Kausalkette starten
                </span>
                <div className="w-10 h-10 rounded-full bg-primary/10 border border-primary/20 flex items-center justify-center text-primary group-hover:bg-primary-hover group-hover:text-white transition-all duration-300">
